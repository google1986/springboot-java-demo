package springboot.unittest.controller;


import com.htzw.springboottestdemo.entity.User;
import com.htzw.springboottestdemo.result.FwResult;
import com.htzw.springboottestdemo.service.UserService;
...
//    @FwValidate
    public FwResult createUser(@RequestBody User user, BindingResult bindingResult) {
